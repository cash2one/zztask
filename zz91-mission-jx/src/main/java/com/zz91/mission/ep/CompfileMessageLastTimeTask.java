 ...
 * 统计询盘信息
 */
public class CompfileMessageLastTimeTask implements ZZTask {

	Logger LOG = Logger.getLogger(CompfileMessageLastTimeTask.class);
...
//			CompfileMessageLastTimeTask et=new CompfileMessageLastTimeTask();
//			et.exec(null);
//		} catch (Exception e) {
